...
정본 우선순위: `docs/PROJECT_SPEC.md` > `docs/tasks/TASK_SPECS.md` > `docs/tasks/BOARD.md` > 그 외 문서. `README.md`·`docs/ROADMAP.md`·계정/수익화 런북은 T16(2026-08-18)에서 스펙 v1과 정합화됐고, 그래도 충돌이 남으면 스펙이 이긴다.
