...
> **상태(D-18, 2026-08-23)**: 남은 두 항목의 초안은 [`content-and-market-criteria.md`](content-and-market-criteria.md)
> 3장(A-3·A-5·A-6·A-7)이고 숫자에는 전부 '제안' 라벨이 붙는다. **승인 전에는 합격선이 아니므로** 체크박스를 닫지 않는다.
> 패널 모집 항목(A-1·A-2·A-4)은 `D-18`로 기각됐다.
