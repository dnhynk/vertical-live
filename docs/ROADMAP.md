...
| identity 고지·동의·삭제·compliance 경로 또는 개인 식별 기능 비활성화 결정 | **승인 2026-08-19(D-9)**: (B) 동의자 한정 개방(opt-in 동의·즉시 삭제·**30일 미refresh(미활동) 시 자동 삭제** — 2026-08-19 D-9 정정, [S41] Developer Policies III.E.4.c의 Authorized Data 30일 상한이라 90일 불가). 구현은 T20a/b/c이고 **머지 전까지 코드는 비활성화(A-1)를 유지**한다 |
